 ...
 * @UniqueEntity(
 *     fields={"email"},
 *     message="cet adresse email est dejà utilisée"
 * )
 */
class User implements UserInterface
{
     ...
     * @Assert\Url(message="veuillez renseigner une url valide de votre avatar !")
     */
    private $picture;
    ...
    private $hash;
    /**
     * @Assert\EqualTo(propertyPath="hash" , message="mots de passe  ne sont pas conformes !")
     */
     ...
     * @Assert\Length(min="100" , minMessage="votre message doit faire au moins 100 caractères !")
     */
    private $description;
